        ...
        children: [
          ...
          Padding(
            ...
            child: Row(children: [
              ...
              ElevatedButton.icon(
                onPressed: () =>
                    context.push(AppRoutes.addEmployee).then((_) => _load()),
          ...
          Expanded(
            child: BlocConsumer<EmployeeBloc, EmployeeState>(
              listener: (context, state) {
                // Only reload list after an operation completes
                // Do NOT reload on EmployeeDetailLoaded — that would
                // cancel the detail screen's data before it can display
                      ...
                      builder: (context, constraints) {
                        ...
                        return isGrid
                            ? _EmployeeGrid(
                                employees: employees,
                                onTap: (e) => context
                                    .push(AppRoutes.employeeDetailPath(e.id))
                                    .then((_) => _load()),
                              )
                            : _EmployeeList(
                                employees: employees,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                employee.jobTitle ?? employee.department?.name ?? 'No role',
                style: AppTextStyles.caption
...
class _Avatar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (photoUrl != null && photoUrl.isNotEmpty) {
      ...
      final fullUrl =
          '${AppConfig.baseUrl.replaceAll('/api/v1', '')}/uploads/$clean';
      return CircleAvatar(
        radius: radius,
